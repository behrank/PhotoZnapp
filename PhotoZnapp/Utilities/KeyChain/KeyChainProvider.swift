...
//  Near
//
//  Created by Behran Kankul on 31.07.2018.
...
internal struct KeychainSwiftConstants {
    /// Specifies a Keychain access group. Used for sharing Keychain items between apps.
    internal static var accessGroup: String { return toString(kSecAttrAccessGroup) }
    ...
    internal static func toString(_ value: CFString) -> String {
